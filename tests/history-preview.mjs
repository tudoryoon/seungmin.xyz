...
const read=()=>JSON.parse(localStorage.getItem('history-preview-choices')||'[]');
const query=table=>({select(){return this},eq(){return this},order(){return this},range(){return this},gte(){return this},lt(){return this},limit(){return this},then(resolve){resolve({data:table==='roulette_choices'?read():table==='daily_tasks'?past:[],error:null})}});
