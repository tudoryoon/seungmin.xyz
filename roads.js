...
export const ROAD_MAPS = {
  wide: {
    size:[1586,992],
    radius:42,
    bridges:[{from:[720,510],to:[470,621],width:100}],
    ...
    routes:{
      ...
      roulette:[[792,483],[720,510],[470,621],[436,641],[384,654],[327,679],[283,663],[246,665],[228,687],[216,719],[194,685],[181,650]]
    }
  },
  tall: {
    size:[941,1672],
    radius:44,
    bridges:[{from:[395,838],to:[174,788],width:104}],
    ...
    routes:{
      ...
      roulette:[[452,859],[395,838],[174,788],[139,801],[116,770],[106,735]]
    }
  }
};
