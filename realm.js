import { parseAvatar, paintAvatar, validAvatar, avatarTraits, avatarTitle, DEFAULT_PROMPT } from './avatar.js?v=20260914-1';
import { validProfile } from './profile.js?v=20260914-1';
import { createDungeon } from './dungeon.js?v=20260914-1';
import { resolveRealmStage } from './realm-route.js?v=20260914-1';
...
import('./portal.js?v=20260914-1').then(({ createPortal }) => {
