...
try {
  for (const revision of ['00b6242','fcb8416','5367651']) {
    ...
    try {
      ...
      for (const file of ['realm.js','realm-route.js','portal.js','avatar.js','profile.js','dungeon.js','roads.js','bridges.js','styles.css','dungeon.css','continuity.css','player-level.js']) {
