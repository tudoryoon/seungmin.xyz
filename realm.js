import { parseAvatar, paintAvatar, validAvatar, avatarTraits, avatarTitle, DEFAULT_PROMPT } from './avatar.js?v=20260912-8';
import { validProfile } from './profile.js?v=20260912-8';
import { createDungeon } from './dungeon.js?v=20260912-8';
import { resolveRealmStage } from './realm-route.js?v=20260912-8';
...
import('./portal.js?v=20260912-8').then(({ createPortal }) => {
